...
## 8. Key Features of the To-Be Process
...
### Decision Automation
- Supplier evaluation using business rules  
...
- Centralized CRM and document repository  
- Structured comparison of supplier offers  

### Process Reliability
- Timer-based reminders  
- Iterative negotiation loops  

---

## 9. Alignment with Project Requirements

The process supports key project evaluation criteria such as:

- Digitalisation and automation of business processes  
- Integration of human-centric tasks  
- Structured data management  
- Decision automation  
- Clear and well-structured documentation :contentReference[oaicite:1]{index=1}  
